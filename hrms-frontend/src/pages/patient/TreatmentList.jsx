import { getTreatmentByPatientId } from "../../api/List";
        ...
        useEffect(() => {
            const loadTreatmentList = async () => {
                try {
                    ...
                    const list = await getTreatmentByPatientId(id);
                ...
                <div className="bg-white shadow-xl rounded-2xl overflow-hidden">
                    <table className="w-full">
                        <thead className="bg-indigo-600 text-white">
                            <tr className="border-b"><th className="p-4 text-left">Doctor Name</th><th className="p-4 text-left">Diagnosis</th><th className="p-4 text-left">Prescribed Medication</th><th className="p-4 text-left">Date</th></tr>
                        </thead>
                        <tbody>
